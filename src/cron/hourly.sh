...
# XO NOT AUTOVERSION
#=======================================================================================================================
version=2.2.4 # -- dscudiero -- Mon 10/16/2017 @ 13:18:27.96
#=======================================================================================================================
...
#=======================================================================================================================
TrapSigs 'on'
myIncludes='FindExecutable GetDefaultsData ParseArgsStd ParseArgs RunSql2 GetPW SetFileExpansion'
myIncludes="$myIncludes RunSql2 ProtectedCall"
Import "$myIncludes"
