...
# XO NOT AUTOVERSION
#=======================================================================================================================
version="4.0.3" # -- dscudiero -- Thu 10/18/2018 @ 13:41:44
#=======================================================================================================================
...
function Usage {
	Error "$1"
	Msg "Usage: $myName -siteDir \"siteDir dirName\" -dataFile \"dataFile fileName\" <Options>"
	...
	Msg "^^Options:"
	Msg "^^^-informationOnly -- Do not actually load the data, just analyze the data for correctness"
	Goodbye -3
}
...
function Initialization {
	...
	while [[ $# -gt 0 ]]; do
	    ...
	    [[ $1 =~ ^-info|--informationOnly$ ]] && { informationOnlyMode=true; }
...
## 10-18-2018 @ 13:42:28 - 4.0.3 - dscudiero - Add informationOnly to the Usage text
