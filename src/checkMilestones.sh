...
#XO NOT AUTOVERSION
#=======================================================================================================================
version="1.0.5" # -- dscudiero -- Tue 10/30/2018 @ 16:06:47
#=======================================================================================================================
#= Description #========================================================================================================
#
#
	...
	if [[ ${#resultSet[@]} -gt 0 ]]; then
		...
		for key in "${!milestones[@]}"; do
			...
			while [ true ]; do
				...
				Msg 1 "^$cntr) $name ($code) -- $project, '$milestone' is due in $daysToDue days ($date)"
...
## Check-in log
#============================================================================================================================================
## 11-01-2018 @ 11:28:29 - 1.0.5 - dscudiero - Tweak messaging
