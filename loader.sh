...
## XO NOT AUTOVERSION
#===================================================================================================
version="1.3.80" # -- dscudiero -- Fri 09/29/2017 @  8:10:42.79
#===================================================================================================
...
## XO NOT AUTOVERSION
#===================================================================================================
version="1.3.64" # -- dscudiero -- Fri 09/29/2017 @  6:56:23.32
#===================================================================================================
# $callPgmName "$executeFile" ${executeFile##*.} "$libs" $scriptArgs
#===================================================================================================
# Copyright 2016 David Scudiero -- all rights reserved.
...
[[ $userName == 'dscudiero' ]] && echo && echo "HERE 1"
	## What auth groups is this user in
		unset UsersAuthGroups
		sqlStmt="select code from $authGroupsTable where members like \"%,$userName,%\""
[[ $userName == 'dscudiero' ]] && echo "sqlStmt = '$sqlStmt'"
		RunSql2 $sqlStmt
[[ $userName == 'dscudiero' ]] && echo "\${#resultSet[@]} = '${#resultSet[@]}'"
[[ $userName == 'dscudiero' ]] && echo && echo "HERE 1a"

		if [[ ${#resultSet[@]} -ne 0 ]]; then
[[ $userName == 'dscudiero' ]] && echo && echo "HERE 1b"
			for ((i=0; i<${#resultSet[@]}; i++)); do
				UsersAuthGroups="$UsersAuthGroups,${resultSet[$i]}"
			done
			UsersAuthGroups=${UsersAuthGroups:1}
...
[[ $userName == 'dscudiero' ]] && echo "HERE 3"
## Call the script
	## Initialize the log file
		sTime=$(date "+%s")
		logFile=/dev/null
	...
	prtStatus ", logFile"
	sTime=$(date "+%s")
[[ $userName == 'dscudiero' ]] && echo "HERE 4"
...
## XO NOT AUTOVERSION
#===================================================================================================
version="1.3.77" # -- dscudiero -- Fri 09/29/2017 @  7:30:23.33
#===================================================================================================
# $callPgmName "$executeFile" ${executeFile##*.} "$libs" $scriptArgs
#===================================================================================================
# Copyright 2016 David Scudiero -- all rights reserved.
...
## 08-24-2017 @ 10.06.49 - dscudiero - Add SendEmail to default import list
## 09-28-2017 @ 13.01.36 - ("1.3.57")  - dscudiero - Set globel USELOCAL if script begins with 'test'
## 09-29-2017 @ 08.10.58 - ("1.3.80")  - dscudiero - General syncing of dev to prod
